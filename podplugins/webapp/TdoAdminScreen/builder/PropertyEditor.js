sap.ui.define(['sap/dm/dme/podfoundation/control/PropertyEditor'], function(PropertyEditor) {
  ...
  var oPropertyEditor = PropertyEditor.extend('rose.ext.podplugins.TdoAdminScreen.builder.PropertyEditor', {
    constructor: function(sId, mSettings) {
      PropertyEditor.apply(this, arguments);
      this.setI18nKeyPrefix('TdoAdminScreen.');
      this.setResourceBundleName('rose.ext.podplugins.TdoAdminScreen.i18n.builder');
      this.setPluginResourceBundleName('rose.ext.podplugins.TdoAdminScreen.i18n.i18n');
    },
